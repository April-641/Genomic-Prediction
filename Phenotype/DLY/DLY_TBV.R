...
save.image("DLY_TBV.RData")
write.table(qtn_geno,"DLY_qtn_geno.txt",quote = F,sep = "\t",row.names = F,col.names = T)
write.table(Genetic_effect,"DLY_TBV.txt",quote = F,sep = "\t",row.names = F,col.names = F)
