...
save.image("LY_TBV.RData")
write.table(qtn_geno,"LY_qtn_geno.txt",quote = F,sep = "\t",row.names = F,col.names = T)
write.table(Genetic_effect,"LY_TBV.txt",quote = F,sep = "\t",row.names = F,col.names = F)
