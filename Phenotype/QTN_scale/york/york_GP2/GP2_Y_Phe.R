...
GP_Y_ind <- 5000
genetic_variance <- 1
Genetic_effect <- read.table("GP2_Y_TBV.txt",header=F)
...
save.image("GP2_Y_Phe.RData")
write.table(phe01,"GP2_Y_Phe01.txt",quote = F,sep = "\t",row.names = F,col.names = F)
write.table(phe03,"GP2_Y_Phe03.txt",quote = F,sep = "\t",row.names = F,col.names = F)
write.table(phe05,"GP2_Y_Phe05.txt",quote = F,sep = "\t",row.names = F,col.names = F)
